...
// Ventana del worklist: cuántos días hacia atrás / adelante se muestran
...
type TablaTel = "Clientes" | "Cobradores" | "Referentes";

interface TelefonoRow extends Telefono {
  tabla: TablaTel;
  idEntidad: number;
}
...
const CUENTAS: CuentaRow[] = [
  { id: 1, nombreDeUsuario: "marcos", rol: "Cobrador", idCobrador: 1 },
  { id: 2, nombreDeUsuario: "luis", rol: "Cobrador", idCobrador: 2 },
  { id: 3, nombreDeUsuario: "diego", rol: "Cobrador", idCobrador: 3 },
];
...
const CLIENTES: Cliente[] = [
  ...
  cliente(14, "23111014", "Marcelo Benítez", 2, "9 de Julio 121", "Gomería · 9 de Julio 121", "Moroso"),
  cliente(15, "29111015", "Silvia Romero", 3, "Italia 655", "Casa · Italia 655"),
  cliente(16, "25111016", "Gustavo Medina", 4, "Av. Independencia 2044", "Local · Independencia 2044"),
  cliente(17, "30111017", "Laura Ibáñez", 5, "Rivadavia 310", "Casa · Rivadavia 310"),
  cliente(18, "22111018", "Ricardo Juárez", 4, "Av. América 1500", "Verdulería · América 1500", "Moroso"),
...
const CUOTA_MONTO: Record<number, number> = {
  1: 25000, 2: 31250, 3: 31250, 4: 15000, 5: 10000, 6: 20000, 7: 12500,
  8: 25000, 9: 8000, 10: 17500, 11: 12000, 12: 22500, 13: 14000, 14: 27500,
  15: 10500, 16: 16000, 17: 11500, 18: 24000, 19: 13500, 20: 26000, 21: 9500,
};
...
const PLANES: PlanDePagos[] = [
  ...
  { id: 22, idCuentaCorriente: 1, nombre: "Financiación mercadería (saldada)", montoTotal: 200000, status: "Completado" },
  { id: 23, idCuentaCorriente: 2, nombre: "Financiación electro", montoTotal: 250000, status: "Incumplido" },
  { id: 24, idCuentaCorriente: 3, nombre: "Refinanciación anterior", montoTotal: 187500, status: "Refinanciado" },
];
...
function seedDb(): MockDb {
  ...
  const clienteDePlan = (planId: number) =>
    PLANES.find((p) => p.id === planId)!.idCuentaCorriente;
...
/** Worklist del cobrador: cuotas en la ventana alrededor de la fecha de trabajo */
export function cobrosDeLaVentana(db: MockDb, fecha: string): CobroDelDia[] {
  const lo = addDays(-VENTANA_PASADO, fecha);
  const hi = addDays(VENTANA_FUTURO, fecha);
  return db.pagosPorRealizar
    .filter((pp) => pp.fechaAcordada >= lo && pp.fechaAcordada <= hi)
...
export function buildEstadoDeCuenta(db: MockDb, clienteId: number): EstadoDeCuenta {
  ...
  return {
    ...
    saldoPendiente: planes.filter((p) => p.status === "Activo").reduce((s, p) => s + p.pendiente, 0),
