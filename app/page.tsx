...
/** La raíz no tiene pantalla propia: la app arranca en los cobros del día. */
const DESTINO = "/cobros";

/**
 * Manda a los cobros del día con un `<meta refresh>`, no con `redirect()`.
 *
 ...
 * O sea que la URL más corta de la app —la que uno le pasa a alguien— caía
 ...
 *
 * ⚠️ El `basePath` se arma a mano. La app se sirve desde una subcarpeta del
  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center justify-center gap-3 p-6 text-center">
        <p className="text-muted-foreground">Abriendo…</p>
