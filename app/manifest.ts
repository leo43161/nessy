 ...
 *
 * ⚠️ **Las rutas llevan el `basePath` a mano.** La app se sirve desde una
...
export default function manifest(): MetadataRoute.Manifest {
  ...
  return {
    name: "Preferenciale — Cobros",
    // El que se ve debajo del icono: entran unos 12 caracteres.
    short_name: "Preferenciale",
    description: "A quién, cuánto y dónde cobrar cada día",
    // Arranca en la lista de cobros del día y no en la raíz: la raíz solo redirige, y en una
    // app instalada ese salto se ve como un parpadeo al abrir.
    start_url: `${base}/cobros/`,
    scope: `${base}/`,
    display: "standalone",
